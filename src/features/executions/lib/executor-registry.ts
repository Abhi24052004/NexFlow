...
import { googleSheetTriggerExecutor } from "@/features/triggers/components/google-sheet-trigger/executor";
...
export const executorRegistry: Record<NodeType, NodeExecutor> = {
  ...
  [NodeType.GOOGLE_SHEET_TRIGGER]: googleSheetTriggerExecutor,
